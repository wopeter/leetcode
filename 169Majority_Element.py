"""
Description
Given an array of size n, find majority Element. The majority element is the element that
appears more than [n/2] times. You may assume that the array is non_empty and the majority element always exist
in the array.
...
class Solution:
    def majorityElement(self, nums):
        ...
        return candidate
    def majortityElement2(self, nums):
        nums.sort()
